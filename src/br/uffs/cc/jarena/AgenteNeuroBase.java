...
/**
 * Politica neural compartilhada por agentes neurais de equipes diferentes.
 */
abstract class AgenteNeuroBase extends Agente {
	private final String equipe;
	private final String propriedadePesosPrimaria;
	private final String propriedadePesosFallback;
	...
	public AgenteNeuroBase(Integer x, Integer y, Integer energia, String nomeEquipe, String propPrimaria, String propFallback) {
		super(x, y, energia);
		equipe = nomeEquipe;
		propriedadePesosPrimaria = propPrimaria;
		propriedadePesosFallback = propFallback;
		entradas = 12;
		ocultos = 8;
		saidas = 6;
	...
	private double[] carregaPesos() {
		...
		String textoPesos = System.getProperty(propriedadePesosPrimaria);

		if (textoPesos == null || textoPesos.trim().length() == 0) {
			textoPesos = System.getProperty(propriedadePesosFallback);
		}
